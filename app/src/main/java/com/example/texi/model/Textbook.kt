...
val textbooks = mutableListOf(
    ...
    Textbook(
        imageResId = R.drawable.img_textbook_introduction_to_teaching_making_a_difference_in_student_learning_3ed,
    ...
    Textbook(
        imageResId = R.drawable.img_textbook_environmental_education_and_education_for_sustainability_2ed,
    ...
    Textbook(
        imageResId = R.drawable.img_textbook_computer_networks_a_systems_approach_6ed,
    ...
    Textbook(
        imageResId = R.drawable.img_textbook_juta_criminal_procedure_handbook_12ed,
    ...
    Textbook(
        imageResId = R.drawable.img_textbook_introducing_javafx_8_programming_1ed,
