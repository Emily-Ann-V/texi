...
class EditUploadedTextbookDetailsFragment: Fragment(R.layout.fragment_edit_uploaded_textbook_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val ibEdit = view.findViewById<ImageButton>(R.id.ib_edit_uploaded_textbook_details_edit_cover_image_icon)
        ...
        val ivImage = view.findViewById<ImageView>(R.id.iv_edit_uploaded_textbook_details_cover_image)
        ...
        val etDescription = view.findViewById<EditText>(R.id.et_edit_uploaded_textbook_details_description)
        ...
        btnSave.setOnClickListener {
            ...
            if (updateUploadValidation(uploadedImageUriInput,titleLetterCount,authorLetterCount,isbnInputString,descriptionLetterCount,priceInput)){
                updateUploadedTextbook(isbn!!,uploadedImageResIdInput,uploadedImageUriInput,titleInput,authorInput,isbnInput!!,descriptionInput,priceInput!!)
